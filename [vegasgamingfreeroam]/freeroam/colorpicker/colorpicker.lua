...
colorPicker = {
	...
	constructor = function( info )
		...
		colorPicker.GUI.selectWindow = guiCreateWindow(screenW - info.selectWindow.width-10, (screenH - info.selectWindow.height) / 2,info.selectWindow.width,440, "RENK AYARLAMA",false)
		guiSetVisible(colorPicker.GUI.selectWindow, false)
		--guiWindowSetMovable(colorPicker.GUI.selectWindow, true)

		colorPicker.GUI.palette = guiCreateStaticImage(colorPicker.selectWindow.paletteX, colorPicker.selectWindow.paletteY,256, 256, "colorpicker/palette.png", false, colorPicker.GUI.selectWindow)
		colorPicker.GUI.alphaBar = guiCreateStaticImage(colorPicker.selectWindow.paletteX + 255 + colorPicker.selectWindow.alphaOffset, colorPicker.selectWindow.paletteY,colorPicker.selectWindow.alphaWidth, 255, "colorpicker/alpha.png", false, colorPicker.GUI.selectWindow)
		colorPicker.isSelectOpen = false
		
		-- Create the RGB and HSL edit boxes
		colorPicker.children.R = guiCreateEdit(info.selectWindow.rgbX - 248, info.selectWindow.rgbY-10, info.selectWindow.rgbWidth, info.selectWindow.rgbHeight, tostring( colorPicker.value[1] ), false, colorPicker.GUI.selectWindow)
		...
		colorPicker.GUI.labelR = guiCreateLabel(info.selectWindow.rgbX-247, info.selectWindow.rgbY + 13,50, 20, "R", false, colorPicker.GUI.selectWindow)
		guiSetFont(colorPicker.GUI.labelR, "default-bold-small")
		--guiLabelSetHorizontalAlign(colorPicker.GUI.labelR,"center")

		colorPicker.children.G = guiCreateEdit(info.selectWindow.rgbX - 195, info.selectWindow.rgbY-10, info.selectWindow.rgbWidth, info.selectWindow.rgbHeight, tostring( colorPicker.value[2] ), false, colorPicker.GUI.selectWindow)
		...
		colorPicker.GUI.labelG = guiCreateLabel(info.selectWindow.rgbX-194, info.selectWindow.rgbY + 13,10, 20, "G", false, colorPicker.GUI.selectWindow)
		guiSetFont(colorPicker.GUI.labelG, "default-bold-small")

		colorPicker.children.B = guiCreateEdit(info.selectWindow.rgbX - 141, info.selectWindow.rgbY-10, info.selectWindow.rgbWidth, info.selectWindow.rgbHeight, tostring( colorPicker.value[3] ), false, colorPicker.GUI.selectWindow)
		...
		colorPicker.GUI.labelB = guiCreateLabel(info.selectWindow.rgbX - 141, info.selectWindow.rgbY+13,10, 20, "B", false, colorPicker.GUI.selectWindow)
		guiSetFont(colorPicker.GUI.labelB, "default-bold-small")
		
		colorPicker.children.A = guiCreateEdit(info.selectWindow.rgbX - 40, info.selectWindow.rgbY-10, info.selectWindow.rgbWidth, info.selectWindow.rgbHeight, tostring( colorPicker.value[4] ), false, colorPicker.GUI.selectWindow)
		...
		colorPicker.GUI.labelA = guiCreateLabel(info.selectWindow.rgbX - 80, info.selectWindow.rgbY-7,50, 20, "ALPHA", false, colorPicker.GUI.selectWindow)
		...
		checkColor1 = guiCreateCheckBox(info.selectWindow.rgbX - 80,info.selectWindow.rgbY+25,70, 15,"Renk1", false, false, colorPicker.GUI.selectWindow)
		checkColor2 = guiCreateCheckBox(info.selectWindow.rgbX - 80,info.selectWindow.rgbY+55,70, 15,"Renk2", false, false, colorPicker.GUI.selectWindow)
		checkColor3 = guiCreateCheckBox(info.selectWindow.rgbX + 10,info.selectWindow.rgbY+25,70, 15,"Renk3", false, false, colorPicker.GUI.selectWindow)
		checkColor4 = guiCreateCheckBox(info.selectWindow.rgbX + 10,info.selectWindow.rgbY+55,250, 15,"Renk4", false, false, colorPicker.GUI.selectWindow)
		checkColor5 = guiCreateCheckBox(info.selectWindow.rgbX - 250,info.selectWindow.rgbY+92,70, 15,"Far Rengi", false, false, colorPicker.GUI.selectWindow)
		checkColor6 = guiCreateCheckBox(info.selectWindow.rgbX - 160,info.selectWindow.rgbY+80,125, 15,"Ön Jant Rengi", false, false, colorPicker.GUI.selectWindow)
		checkColor7 = guiCreateCheckBox(info.selectWindow.rgbX - 160,info.selectWindow.rgbY+110,125, 15,"Arka Jant Rengi", false, false, colorPicker.GUI.selectWindow)
		dumansag    = guiCreateCheckBox(info.selectWindow.rgbX - 43,info.selectWindow.rgbY+80,150, 15,"Duman Rengi Sağ", false, false, colorPicker.GUI.selectWindow)
		dumansol    = guiCreateCheckBox(info.selectWindow.rgbX - 43,info.selectWindow.rgbY+110,150, 15,"Duman Rengi Sol", false, false, colorPicker.GUI.selectWindow)
...
--Wont work until I get the actual mouse working
		...
		local boxWidth = (colorPicker.selectWindow.historyWidth - 15) / 2.6
...
addEvent("seriuslib:close",true)
addEventHandler("seriuslib:close",root,function()
	colorPicker.closeSelect()
end)